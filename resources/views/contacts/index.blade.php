                ...
                <div class="table-responsive">
                    <table class="pages-table" style="min-width: 900px;">
                        ...
                        <tbody>
                            @for ($i = 0; $i < 2; $i++)
                                <tr>
                                    <td><input type="text" name="contacts[{{ $i }}][en_title]" class="form-control" placeholder="English Title"></td>
                                    <td><input type="text" name="contacts[{{ $i }}][en_value]" class="form-control" placeholder="English Value"></td>
                                    <td><input type="text" name="contacts[{{ $i }}][fr_title]" class="form-control" placeholder="French Title"></td>
                                    <td><input type="text" name="contacts[{{ $i }}][fr_value]" class="form-control" placeholder="French Value"></td>
                                    <td><input type="text" name="contacts[{{ $i }}][ar_title]" class="form-control" placeholder="Arabic Title" dir="rtl"></td>
                                    <td><input type="text" name="contacts[{{ $i }}][ar_value]" class="form-control" placeholder="Arabic Value" dir="rtl"></td>
                                    <td>
